...
<body>
    ...
    <div class="container-fluid">
        ...
        <div class="round3">
            ...
            If others : <br>
            <textarea id="testone" rows="4" cols="120" name="managements others"
                      value="{{old('date') ?? $incident->management_others}}"
                      placeholder="Enter other management detail here">{{$incident->management_others}}</textarea>
            <br><br>


            <label9><b> Gastrointestinal decontamination : </b><br><br>
                <input type="checkbox"
                       name="management[]"
                       value="15"
                > Gastric_aspiration<br><br>
                <input type="checkbox"
                       name="management[]"
                       value="1">
                Activated chracol<br>
