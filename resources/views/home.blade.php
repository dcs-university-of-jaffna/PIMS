...
<nav class="navbar navbar-expand-lg navbar-light bg-light" id="main_navbar">
            ...
            <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="navbarDropdown1">
                            <li><a class="dropdown-item" href="{{ url('/Aththana_detail_form1') }}">Aththana (Datura
                                    stramonium)</a></li>
                            <li><a class="dropdown-item" href="{{ url('/Divikaduru_detail_form1') }}">Divi kaduru
                                    (Tabernaemantana dichotoma)</a></li>
                            <li><a class="dropdown-item" href="{{ url('/Diyakaduru_detail_form1') }}">Diya Kaduru
                                    (Cerebra manghas)</a></li>
    ...
    <form class="form-inline my-2 my-lg-0" action="/phnsearch" method="POST">
        {{csrf_field()}}
        <input class="form-control mr-sm-2" type="number" min="0" name="phn" placeholder="Search" aria-label="Search"
               required>
                    ...
                    <div class="job-post-item bg-white p-4 d-block d-md-flex align-items-center">
                        ...
                        <div class="mb-4 mb-md-0 mr-5">
                            <div class="job-post-item-header d-flex align-items-center">
                                <h2 class="mr-3 text-black h4">{{$incident->toxicity->name}}</h2>
                                <div class="badge-wrap">
                                    <span class="bg-primary text-white badge py-2 px-4">{{$incident->patient->phn}}</span>
                                </div>
                            </div>
                            <div class="job-post-item-body d-block d-md-flex">
                                <div class="mr-3">
                                    <span class="fl-bigmug-line-portfolio23"></span>
                                    <a href="#">{{$incident->patient->name}}</a>
                                </div>
                                <div>
                        ...
                        <div class="ml-auto">
                            <span> last update:{{$incident->updated_at}}  </span>
                            <a href="/incidents/{{$incident->id}}" class="btn btn-dark py-2">Update</a>
                        </div>
                    </div>
                    @endforeach
                </div>
