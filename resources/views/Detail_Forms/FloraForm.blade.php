        ...
        <form action="/submitFlora" method="post">
            ...
            <div data-panel="three">
                ...
                @elseif($ray==2)
                    ...
                    <input type="checkbox" name="AththanaClinical[]" value="39"> Disturbance of consciousnessvalue
                    <br>
                ...
                @elseif($ray==3)
                    ...
                    <input type="checkbox" name="AththanaClinical[]" value="93"> Numbness and burning of mouth    <br>
                    <br>
                    ...
                    <label11>
                        ...
                        <input type="checkbox" name="AththanaClinical[]" value="9"> Atrial and ventricular ectopics <br>
                        <br>
            ...
            <div data-panel="four">
                ...
                <br>
                If others : <br>
                <textarea rows="4" cols="120" name="managements others"
