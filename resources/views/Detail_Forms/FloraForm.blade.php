...
<form action="/submitFlora" method="post">
 ...
 <label_A1>   
            <label>First Name :</label>
                ...
                <textarea rows = "3" cols = "150" placeholder="Enter address here" name = "address" value ="{{$request->address}}"></textarea>
      <br>
                 ...
                 <label_B1>
                    <label>Second Name :</label>
                        <input type="text" name="Sname" required="true" value ="{{$request->Sname}}" >          
                <br><br>
