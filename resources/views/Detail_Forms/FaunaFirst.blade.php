...
<div class="form">
    <h2 style="text-align: center">  New Patient Detail </h2>
         ...
         @if($ray==13)
         <label><b> Poison : Bee, Wasp, Hornet Stings</b></label>
         @elseif($ray==14)
         <label><b> Poison : Black Widow Spider  </b></label>
         @elseif($ray==21)
         <label><b> Poison : Blister Beetle ingestion </b></label>
         @elseif($ray==15)
         <label><b> Poison : Centipede Bite </b></label>
         @elseif($ray==16)
         <label><b> Poison : Jelly Fish  </b></label>
         @elseif($ray==17)
         <label><b> Poison : Scorpion Bite</b></label>
         @elseif($ray==18)
         <label><b> Poison : Snake Bite </b></label>
         @elseif($ray==19)
         <label><b> Poison : Turtle Flesh Poisoning  </b></label>
         @elseif($ray==20)
         <label><b> Poison : Unknown Bite</b></label>
         @endif 
