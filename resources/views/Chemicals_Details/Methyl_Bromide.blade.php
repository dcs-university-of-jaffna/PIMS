                                    ...
                                    <div class="tab-pane" id="clinical">
                                            ...
                                            <div class="row">
                                                <div class="col-sm-3">
                                                    ...
                                                    <div class="row-sm-6">
                                                        <div class="choice" data-toggle="wizard-checkbox">
                                                            <input type="checkbox" name="cerebellar_dysfunction">
                                                            <div class="icon">
                                                ...
                                                <div class="col-sm-3">
                                                    ...
                                                    <div class="row-sm-6">
                                                        <div class="choice" data-toggle="wizard-checkbox">
                                                            <input type="checkbox" name="itching">
                                                            <div class="icon">
                                                                <i class="fa fa-laptop"></i>
                                                            </div>
                                                ...
                                                <div class="col-sm-3">
                                                    <div class="row-sm-6">
                                                        <div class="choice" data-toggle="wizard-checkbox">
                                                            <input type="checkbox" name="motor_sensory_palsy">
                                                            <div class="icon">
                                                                <i class="fa fa-laptop"></i>
                                                            </div>
                                                    ...
                                                    <div class="row-sm-6">
                                                        <div class="choice" data-toggle="wizard-checkbox">
                                                            <input type="checkbox" name="myocionus">
                                                            <div class="icon">
                                                                <i class="fa fa-laptop"></i>
                                                            </div>
                                                    ...
                                                    <div class="row-sm-6">
                                                        <div class="choice" data-toggle="wizard-checkbox">
                                                            <input type="checkbox" name="periperal_neuropathy">
                                                            <div class="icon">
                                                                <i class="fa fa-pencil"></i>
                                                            </div>
                                                ...
                                                <div class="col-sm-3">
                                                    ...
                                                    <div class="row-sm-6">
                                                        <div class="choice" data-toggle="wizard-checkbox">
                                                            <input type="checkbox" name="skin_blisters">                                                            <div class="icon">
                                                                <i class="fa fa-pencil"></i>
                                                            </div>
                                                    ...
                                                    <div class="row-sm-6">
                                                        <div class="choice" data-toggle="wizard-checkbox">
                                                            <input type="checkbox" name="slurred_speech">
                                                            <div class="icon">
                                                                <i class="fa fa-terminal"></i>
                                                            </div>
                                                    ...
                                                    <div class="row-sm-6">
                                                        <div class="choice" data-toggle="wizard-checkbox">
                                                            <input type="checkbox" name="visual_disturbance">
                                                            <div class="icon">
                                                                <i class="fa fa-laptop"></i>
                                                            </div>
