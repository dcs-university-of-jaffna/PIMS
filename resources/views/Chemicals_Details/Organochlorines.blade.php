                                    ...
                                    <div class="tab-pane" id="clinical">
                                            ...
                                            <div class="row">
                                                <div class="col-sm-2">
                                                    ...
                                                    <div class="row-sm-6">
                                                        <div class="choice" data-toggle="wizard-checkbox">
                                                            <input type="checkbox" name="cardiac_arrythmia">
                                                            <div class="icon">
                                                ...
                                                <div class="col-sm-3">
                                                    ...
                                                    <div class="row-sm-6">
                                                        <div class="choice" data-toggle="wizard-checkbox">
                                                            <input type="checkbox" name="dysarthria">
                                                            <div class="icon">
                                                                <i class="fa fa-laptop"></i>
                                                            </div>
                                                ...
                                                <div class="col-sm-2">
                                                    ...
                                                    <div class="row-sm-6">
                                                        <div class="choice" data-toggle="wizard-checkbox">
                                                            <input type="checkbox" name="hyperaesthesia">
                                                            <div class="icon">
                                                                <i class="fa fa-laptop"></i>
                                                            </div>
                                                    ...
                                                    <div class="row-sm-6">
                                                        <div class="choice" data-toggle="wizard-checkbox">
                                                            <input type="checkbox" name="palpitation">
                                                            <div class="icon">
                                                                <i class="fa fa-laptop"></i>
                                                            </div>
                                                ...
                                                <div class="col-sm-2">
                                                    <div class="row-sm-6">
                                                        <div class="choice" data-toggle="wizard-checkbox">
                                                            <input type="checkbox" name="pulmanany_oedema">
                                                            <div class="icon">
                                                                <i class="fa fa-laptop"></i>
                                                            </div>
                                                    ...
                                                    <div class="row-sm-6">
                                                        <div class="choice" data-toggle="wizard-checkbox">
                                                            <input type="checkbox" name="renalfailure">                                                            <div class="icon">
                                                                <i class="fa fa-pencil"></i>
                                                            </div>
