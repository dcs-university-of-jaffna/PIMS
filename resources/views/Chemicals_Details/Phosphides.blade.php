                                    ...
                                    <div class="tab-pane" id="clinical">
                                            ...
                                            <div class="row">
                                                <div class="col-sm-3">
                                                    <div class="row-sm-6">
                                                        <div class="choice" data-toggle="wizard-checkbox">
                                                            <input type="checkbox" name="bdominal_pain">
                                                            <div class="icon">
                                                    ...
                                                    <div class="row-sm-6">
                                                        <div class="choice" data-toggle="wizard-checkbox">
                                                            <input type="checkbox" name="acute_renal_failure">
                                                            <div class="icon">
                                                    ...
                                                    <div class="row-sm-6">
                                                        <div class="choice" data-toggle="wizard-checkbox">
                                                            <input type="checkbox" name="bleeding_tendencies">
                                                            <div class="icon">
                                                                <i class="fa fa-laptop"></i>
                                                            </div>
                                                ...
                                                <div class="col-sm-3">
                                                    <div class="row-sm-6">
                                                        <div class="choice" data-toggle="wizard-checkbox">
                                                            <input type="checkbox" name="chest_tightnes">
                                                            <div class="icon">
                                                                <i class="fa fa-terminal"></i>
                                                            </div>
                                                    ...
                                                    <div class="row-sm-6">
                                                        <div class="choice" data-toggle="wizard-checkbox">
                                                            <input type="checkbox" name="caugh">
                                                            <div class="icon">
                                                                <i class="fa fa-laptop"></i>
                                                            </div>
                                                    ...
                                                    <div class="row-sm-6">
                                                        <div class="choice" data-toggle="wizard-checkbox">
                                                            <input type="checkbox" name="dysrhythmias">
                                                            <div class="icon">
                                                                <i class="fa fa-pencil"></i>
                                                            </div>
                                                ...
                                                <div class="col-sm-3">
                                                    ...
                                                    <div class="row-sm-6">
                                                        <div class="choice" data-toggle="wizard-checkbox">
                                                            <input type="checkbox" name="jaundice">
                                                            <div class="icon">
                                                                <i class="fa fa-laptop"></i>
                                                            </div>
                                                    ...
                                                    <div class="row-sm-6">
                                                        <div class="choice" data-toggle="wizard-checkbox">
                                                            <input type="checkbox" name="metabolic_acidesis">
                                                            <div class="icon">
                                                                <i class="fa fa-pencil"></i>
                                                            </div>
                                                ...
                                                <div class="col-sm-3">
                                                    <div class="row-sm-6">
                                                        <div class="choice" data-toggle="wizard-checkbox">
                                                            <input type="checkbox" name="oliguria">
                                                            <div class="icon">
                                                                <i class="fa fa-laptop"></i>
                                                            </div>
                                                    ...
                                                    <div class="row-sm-6">
                                                        <div class="choice" data-toggle="wizard-checkbox">
                                                            <input type="checkbox" name="pulmonany_oedema">                                                            <div class="icon">
                                                                <i class="fa fa-pencil"></i>
                                                            </div>
                                                    ...
                                                    <div class="row-sm-6">
                                                        <div class="choice" data-toggle="wizard-checkbox">
                                                            <input type="checkbox" name="respiratory_alkalesis">
                                                            <div class="icon">
                                                                <i class="fa fa-terminal"></i>
                                                            </div>
