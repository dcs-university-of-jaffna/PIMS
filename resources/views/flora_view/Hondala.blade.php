...
<div class="row">
 ...
 <div class="row"> 
   ...
   <div class="col">
        <div class="form-group">
            <div class="form-check">
            <input class="form-check-input" type="checkbox" readonly value="40" @if($symptoms->contains(40)) checked @endif>
            <label class="form-check-label" for="gridCheck">
            &nbsp;   Dizziness
            </label>
            </div>
...
<div class="row"> 
   ...
   <div class="col">
        <div class="form-group">
            <div class="form-check">
            <input class="form-check-input" type="checkbox" readonly value="70" @if($symptoms->contains(70)) checked @endif>
            <label class="form-check-label" for="gridCheck">
...
<div class="row"> 
    <div class="col">
        <div class="form-group">
            <div class="form-check">
            <input class="form-check-input" type="checkbox" readonly value="92" @if($symptoms->contains(92)) checked @endif>
            <label class="form-check-label" for="gridCheck">
   ...
   <div class="col">
        <div class="form-group">
            <div class="form-check">
            <input class="form-check-input" type="checkbox" readonly value="87" @if($symptoms->contains(87)) checked @endif>
            <label class="form-check-label" for="gridCheck">
            &nbsp;  Myocarditis
            </label>
            </div>
   ...
   <div class="col">
        <div class="form-group">
            <div class="form-check">
            <input class="form-check-input" type="checkbox" readonly value="105" @if($symptoms->contains(105)) checked @endif>
            <label class="form-check-label" for="gridCheck">
            &nbsp;     Papilloedema 
            </label>
            </div>
...
<div class="row"> 
   ...
   <div class="col">
        <div class="form-group">
            <div class="form-check">
            <input class="form-check-input" type="checkbox" readonly value="120" @if($symptoms->contains(120)) checked @endif>
            <label class="form-check-label" for="gridCheck">
            &nbsp;  Retinopathy  
            </label>
            </div>
   ...
   <div class="col">
        <div class="form-group">
            <div class="form-check">
            <input class="form-check-input" type="checkbox" readonly value="122" @if($symptoms->contains(122)) checked @endif>
            <label class="form-check-label" for="gridCheck">
...
<div class="row"> 
    <div class="col">
        <div class="form-group">
            <div class="form-check">
            <input class="form-check-input" type="checkbox" readonly value="134" @if($symptoms->contains(134)) checked @endif>
            <label class="form-check-label" for="gridCheck">
            &nbsp;  Tender liver
            </label>
            </div>
