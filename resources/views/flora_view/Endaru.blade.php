...
<div class="row"> 
   ...
   <div class="col">
        <div class="form-group">
            <div class="form-check">
            <input class="form-check-input" type="checkbox" readonly value="60" @if($symptoms->contains(60)) checked @endif>
            <label class="form-check-label" for="gridCheck">
            &nbsp;     Haematuria
            </label>
            </div>
...
<div class="row"> 
    <div class="col">
        <div class="form-group">
            <div class="form-check">
            <input class="form-check-input" type="checkbox" readonly value="66" @if($symptoms->contains(66)) checked @endif>
            <label class="form-check-label" for="gridCheck">
            &nbsp;  Hepatic Necrosis
            </label>
            </div>
...
<div class="row"> 
    <div class="col">
        <div class="form-group">
            <div class="form-check">
            <input class="form-check-input" type="checkbox" readonly value="27" @if($symptoms->contains(27)) checked @endif>
            <label class="form-check-label" for="gridCheck">
            &nbsp; Cough
            </label>
            </div>
   ...
   <div class="col">
        <div class="form-group">
            <div class="form-check">
            <input class="form-check-input" type="checkbox" readonly value="9" @if($symptoms->contains(77)) checked @endif>
            <label class="form-check-label" for="gridCheck">
            &nbsp;      Hypoxaemia
            </label>
            </div>
...
<div class="row"> 
   ...
   <div class="col">
        <div class="form-group">
            <div class="form-check">
            <input class="form-check-input" type="checkbox" readonly value="116" @if($symptoms->contains(116)) checked @endif>
            <label class="form-check-label" for="gridCheck">
