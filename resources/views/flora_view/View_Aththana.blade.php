...
<div class="row">
 ...
 <div class="row"> 
   ...
   <div class="col">
        <div class="form-group">
            <div class="form-check">
            <input class="form-check-input" type="checkbox" readonly value="42" @if($symptoms->contains(42)) checked @endif >
            <label class="form-check-label" for="gridCheck">
            &nbsp; Dry mouth
            </label>
            </div>
   ...
   <div class="col">
        <div class="form-group">
            <div class="form-check">
            <input class="form-check-input" type="checkbox" readonly value="48" @if($symptoms->contains(48)) checked @endif>
            <label class="form-check-label" for="gridCheck">
            &nbsp;   Erythema
            </label>
            </div>
...
<div class="row"> 
   ...
   <div class="col">
        <div class="form-group">
            <div class="form-check">
            <input class="form-check-input" type="checkbox" readonly value="86" @if($symptoms->contains(86)) checked @endif>
            <label class="form-check-label" for="gridCheck">
            &nbsp;  Mydriasis
            </label>
            </div>
...
<div class="row"> 
    <div class="col">
        <div class="form-group">
            <div class="form-check">
            <input class="form-check-input" type="checkbox" readonly value="3" @if($symptoms->contains(3)) checked @endif>
            <label class="form-check-label" for="gridCheck">
            &nbsp; Agitation  
            </label>
            </div>
   ...
   <div class="col">
        <div class="form-group">
            <div class="form-check">
            <input class="form-check-input" type="checkbox" readonly value="22" @if($symptoms->contains(22)) checked @endif>
            <label class="form-check-label" for="gridCheck">
            &nbsp;  Combative 
            </label>
            </div>
...
<div class="row"> 
    <div class="col">
        <div class="form-group">
            <div class="form-check">
            <input class="form-check-input" type="checkbox" readonly value="38" @if($symptoms->contains(38)) checked @endif>
            <label class="form-check-label" for="gridCheck">
            &nbsp; disorientation 
            </label>
            </div>
