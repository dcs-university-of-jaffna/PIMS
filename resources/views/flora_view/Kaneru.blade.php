...
<div class="row">
 ...
 <div class="row"> 
   ...
   <div class="col">
        <div class="form-group">
            <div class="form-check">
            <input class="form-check-input" type="checkbox" readonly value="7" @if($symptoms->contains(7)) checked @endif >
            <label class="form-check-label" for="gridCheck">
            &nbsp; Anxiety 
            </label>
            </div>
...
<div class="row"> 
    <div class="col">
        <div class="form-group">
            <div class="form-check">
            <input class="form-check-input" type="checkbox" readonly value="141" @if($symptoms->contains(141)) checked @endif>
            <label class="form-check-label" for="gridCheck">
   ...
   <div class="col">
        <div class="form-group">
            <div class="form-check">
            <input class="form-check-input" type="checkbox" readonly value="142" @if($symptoms->contains(142)) checked @endif>
            <label class="form-check-label" for="gridCheck">
   ...
   <div class="col">
        <div class="form-group">
            <div class="form-check">
            <input class="form-check-input" type="checkbox" readonly value="147" @if($symptoms->contains(147)) checked @endif>
            <label class="form-check-label" for="gridCheck">
            &nbsp;     Yellow vision 
            </label>
            </div>
...
<div class="row"> 
   ...
   <div class="col">
        <div class="form-group">
            <div class="form-check">
            <input class="form-check-input" type="checkbox" readonly value="399" @if($symptoms->contains(399)) checked @endif>
            <label class="form-check-label" for="gridCheck">
