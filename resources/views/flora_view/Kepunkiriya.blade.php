...
<div class="row">
 ...
 <div class="row"> 
   ...
   <div class="col">
        <div class="form-group">
            <div class="form-check">
            <input class="form-check-input" type="checkbox" readonly value="20" @if($symptoms->contains(20)) checked @endif>
            <label class="form-check-label" for="gridCheck">
            &nbsp;   CNS depression
            </label>
            </div>
...
<div class="row"> 
    <div class="col">
        <div class="form-group">
            <div class="form-check">
            <input class="form-check-input" type="checkbox" readonly value="45" @if($symptoms->contains(45)) checked @endif>
            <label class="form-check-label" for="gridCheck">
            &nbsp;  Ecg abnormalities
            </label>
            </div>
   ...
   <div class="col">
        <div class="form-group">
            <div class="form-check">
            <input class="form-check-input" type="checkbox" readonly value="62" @if($symptoms->contains(62)) checked @endif>
            <label class="form-check-label" for="gridCheck">
   ...
   <div class="col">
        <div class="form-group">
            <div class="form-check">
            <input class="form-check-input" type="checkbox" readonly value="68" @if($symptoms->contains(68)) checked @endif>
            <label class="form-check-label" for="gridCheck">
            &nbsp;     Hyperpnoea
            </label>
            </div>
...
<div class="row"> 
   ...
   <div class="col">
        <div class="form-group">
            <div class="form-check">
            <input class="form-check-input" type="checkbox" readonly value="107" @if($symptoms->contains(107)) checked @endif>
            <label class="form-check-label" for="gridCheck">
            &nbsp;     Polydipsia
            </label>
            </div>
